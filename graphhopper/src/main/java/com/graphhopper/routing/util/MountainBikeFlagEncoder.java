...
public class MountainBikeFlagEncoder extends BikeCommonFlagEncoder
{
    MountainBikeFlagEncoder()
    {
        ...
        setCyclingNetworkPreference("icn", PriorityCode.PREFER.getValue());
        setCyclingNetworkPreference("ncn", PriorityCode.PREFER.getValue());
        setCyclingNetworkPreference("rcn", PriorityCode.PREFER.getValue());
        setCyclingNetworkPreference("lcn", PriorityCode.PREFER.getValue());
        setCyclingNetworkPreference("mtb", PriorityCode.BEST.getValue());
