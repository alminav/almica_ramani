...
public class InstructionList implements Iterable<Instruction>
{
    ...
    public int type = GH;
    public String routeName; // almica 20apr2024 routename
    public static final InstructionList EMPTY = new InstructionList();
    private final List<Instruction> instructions;
    private final Translation tr;

    public InstructionList() // private --> public almica 20sep2024, problems with EMPTY because it is static
    {
        this(0, null);
    }
    ...
    private void createRteptBlock( StringBuilder output, Instruction instruction, Instruction nextI )
    {
        ...
        output.append("<type>").append(instruction.sign).append("</type>"); // almica 22apr2024
