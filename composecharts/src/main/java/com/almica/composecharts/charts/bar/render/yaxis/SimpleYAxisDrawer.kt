package com.almica.composecharts.charts.bar.render.yaxis
...
import com.almica.composecharts.charts.LabelFormatter
import com.almica.composecharts.charts.toLegacyInt
...
data class SimpleYAxisDrawer(
    ...
    val labelValueFormatter: LabelFormatter = { value -> "%.0f".format(value) },
