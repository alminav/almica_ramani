...
package com.almica.ramani.gpx.beans;
...
public class Waypoint extends Extension {
	...
	public String toString() {
		...
		sb.append("lon:").append(this.longitude).append(" ");
		sb.append("elv:").append(this.elevation).append(" ");
		sb.append("time:").append(date).append(" ");
		sb.append("fix:").append(this.fix).append(" ");
