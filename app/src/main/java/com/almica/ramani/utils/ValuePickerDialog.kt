    ...
    AlertDialog(
        ...
        title = {
            Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth()) {
                ...
                val drawableGreen = remember { ContextCompat.getDrawable(context, R.drawable.circle_filled_green_24px) }
                Image(
                    painter = rememberDrawablePainter(drawable = drawableGreen),
                    contentDescription = null
                )
                Icon(Icons.Outlined.SquareMarkedCorners, contentDescription = null,
                    modifier = Modifier.scale(0.1f + currentSelectedValue, 1f)
                        .rotate(45f)
                        .size(80.dp))
                val drawableRed = remember { ContextCompat.getDrawable(context, R.drawable.circle_filled_red_24px) }
                Image(
                    painter = rememberDrawablePainter(drawable = drawableRed),
                    contentDescription = null
                )
            }
        },
