...
public final class TurfMeta {
   ...
   */
  @NonNull
  public static List<Point> coordAll(@NonNull List<Point> coords,
   ...
   */
  @NonNull
  public static List<Point> addCoordAll(@NonNull List<Point> pointList, @NonNull Feature feature,
                                         @NonNull boolean excludeWrapCoord) {
   ...
   */
  @NonNull
  public static List<Point> coordAllFromSingleGeometry(@NonNull List<Point> pointList,
