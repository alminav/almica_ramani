    ...
    Scaffold(
        ...
        bottomBar = {
            BottomAppBar(actions = {
                ...
                IconButton(
                    modifier = Modifier.visible(cloudMvtMap.containsKey(uiState.regionName + Const.MBTILES_EXT)).weight(1.0f),
                    onClick = {
                        cloudMvtMap[uiState.regionName + Const.MBTILES_EXT]?.let {
                            onDownloadMagenta(
